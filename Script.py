...
<b>ᴜʀʟ ʙᴜᴛᴛᴏɴꜱ:</b>
<code>[Button Text](buttonurl:https://t.me/+mNAb8rPxt0EyMjU9)</code>
<b>ᴀʟᴇʀᴛ ʙᴜᴛᴛᴏɴꜱ:</b>
...
ᴅɪᴅ ʏᴏᴜ ᴍᴇᴀɴ ᴀɴʏ ᴏɴᴇ ᴏꜰ ᴛʜᴇꜱᴇ?"""
    ...
    I_CUDNT = """<b>😔 Oops! No files found for your request: <code>{}</code>

🔍 Please double-check the spelling on Google and try again 😊

🎬 <u>Movie Request Format</u> 👇  
Example: <i>Uncharted</i>  
or <i>Jujutsu Kaisen Execution</i>  
or <i>Naruto</i>

📺 <u>Series Request Format</u> 👇  
Example: <i>Loki S01</i>  
or <i>Loki S01E04</i>  
or <i>Lucifer S03E24</i>
